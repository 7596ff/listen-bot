module.exports = (client, ability) => {
    ...
    let thum = client.config.is_discord_shit ? {} : {
        "url": `http://cdn.dota2.com/apps/dota2/images/abilities/${ability.hero_name}_${client.core.util.clean(ability.name)}_lg.png`
    };

    return {
        "author": {
            "name": ability.name,
            "url": `http://dota2.gamepedia.com/${client.core.util.capitalize_first(ability.hero_name, "_")}#${ability.name.replace(/ /g, "_")}`,
